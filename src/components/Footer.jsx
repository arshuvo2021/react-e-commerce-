...
const Footer = () => {
  ...
  return (
    <footer className="bg-blue-900 py-4 sm:py-6 mt-6 sm:mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          {/* Logo and Copyright */}
          <div className="text-center mb-4">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-2">ReactShop</h3>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4 text-center">
              {footerLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="text-xs sm:text-sm text-blue-200 hover:text-white transition-colors duration-300 py-1"
                >
                  {link.label}
                </a>
              ))}
